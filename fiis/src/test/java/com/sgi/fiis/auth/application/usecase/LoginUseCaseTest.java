...
class LoginUseCaseTest {
        ...
        void testLoginInactiveUser() {
                ...
                assertThrows(BusinessException.class, () -> loginUseCase.execute("inactive@unas.edu.pe", "password"));
        ...
        void testLoginNullEmail() {
                ...
                assertThrows(BadCredentialsException.class, () -> loginUseCase.execute(null, "password"));
