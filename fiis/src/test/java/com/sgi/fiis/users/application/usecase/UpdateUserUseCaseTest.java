...
class UpdateUserUseCaseTest {
    ...
    void testUpdateUserSuccess() {
        ...
        User result = updateUserUseCase.execute(1L, "Juan Carlos", "Perez Gomez",
    ...
    void testUpdateUserDoesNotExist() {
        ...
        assertThrows(ResourceNotFoundException.class, () ->
                updateUserUseCase.execute(1L, "Juan", "Perez", null, null, null));
    ...
    void testUpdateUserEmailDuplicate() {
        ...
        assertThrows(DuplicateResourceException.class, () ->
                updateUserUseCase.execute(1L, null, null, "duplicado@unas.edu.pe", null, null));
    ...
    void testUpdateUserEmailInvalid() {
        ...
        com.sgi.fiis.shared.domain.exception.BusinessException exception = assertThrows(
                ...
                () -> updateUserUseCase.execute(1L, null, null, "invalido@gmail.com", null, null)
        );
