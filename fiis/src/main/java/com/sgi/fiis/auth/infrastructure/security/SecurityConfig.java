...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        try {
            http
                    // Deshabilitar CSRF es seguro aquí porque la API es stateless y utiliza tokens
                    // JWT
                    // enviados en la cabecera 'Authorization: Bearer <token>', no cookies de
                    // sesión,
                    ...
                    .authorizeHttpRequests(auth -> auth
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/v1/research-lines/**").permitAll()
                            .requestMatchers(HttpMethod.GET, "/api/v1/research-groups/**").permitAll()
    ...
    @Bean
    public org.springframework.boot.web.servlet.FilterRegistrationBean<JwtAuthenticationFilter> jwtAuthenticationFilterRegistration(
